...
assert.ok(indexHtml.includes('data-action="selectAllSubmissionsOnPage"'));
assert.ok(indexHtml.includes('id="selectAllSubmissionsBtn"'));
assert.ok(indexHtml.includes('data-action="clearSubmissionSelection"'));
assert.ok(indexHtml.includes('id="bulkSubmitSubmissionsBtn"'));
assert.ok(indexHtml.includes('data-action="bulkSubmitSelectedSubmissions"'));
assert.ok(indexHtml.includes('data-action="bulkDeleteSelectedSubmissions"'));
assert.ok(adminPanelSource.includes('/api/submissions/bulk-action'));
assert.ok(adminPanelSource.includes("runBulkSubmissionAction('submit_for_review')"));
